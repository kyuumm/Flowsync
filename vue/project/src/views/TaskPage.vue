...
const tasks = ref([
  ...
  },
  {
    ...
    priority: '中',
    deadline: '2024-07-16',
    description: '提前检查电脑、投影、网络，预装演示环境'
  },
  {
    title: '明确分工',
    project: '迎新活动协同项目',
